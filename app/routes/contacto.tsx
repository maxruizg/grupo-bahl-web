    ...
    <>
      ...
      <section className="pt-32 pb-8 md:pt-40 md:pb-12 bg-[var(--color-black)] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-gradient-radial from-[rgba(201,162,39,0.03)] to-transparent rounded-full blur-3xl" />
        </div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h1 className="heading-display text-4xl md:text-5xl lg:text-6xl text-white mb-6">
              Hablemos de tu{" "}
              <span className="text-gradient-gold">próximo proyecto</span>
            </h1>
        ...
        <div className="container-custom">
          ...
          >
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[var(--color-gold)]/10 border border-[var(--color-gold)]/20 flex items-center justify-center">
